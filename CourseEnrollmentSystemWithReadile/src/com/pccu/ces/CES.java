...
public class CES extends Student {
	...
	private static void WriteFile (ArrayList<Student> list, String filepath) throws IOException {
	...
	private static void ScoreEnrollment () throws IOException {
	...
	private static void InqueryByIDFromFile (String filepath) throws IOException {
		int id;
		System.out.println("Enter ID :");
